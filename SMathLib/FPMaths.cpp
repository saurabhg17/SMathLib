...
{
	return int((((*(int64_t*)&x & 0x7FF0000000000000LL) >> 52) - 1023));
}
// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ //
...
bool glIsInfinite(double A)
{
	...
	static const int64_t _kInfAsInt = 0x7FF0000000000000LL;
	
	// An infinity has an exponent of 1023 (shift left 52 positions) and
	// a zero mantissa. There are two infinities - positive and negative.
	if ((*(int64_t*)&A & 0x7FFFFFFFFFFFFFFFLL) == _kInfAsInt)
	{
		return true;
	}
	else
...
bool glIsNan(double A)
{
	...
	int64_t _exp      = *(int64_t*)&A & 0x7FF0000000000000LL;
	int64_t _mantissa = *(int64_t*)&A & 0xFFFFFFFFFFFFFLL;
...
Sign glSign(double A)
{
	...
	if(((*(int64_t*)&A) & 0x8000000000000000LL) > 0)
	{
